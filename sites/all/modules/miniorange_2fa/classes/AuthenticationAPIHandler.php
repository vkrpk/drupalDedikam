...
class AuthenticationAPIHandler {
  ...
  public function registerGoogleAuthenticator(MiniorangeUser $user, $secret, $otpToken) {
    $fields = array (
      'customerKey' => $user->getCustomerId(),
      'username' => $user->getUsername(),
      'secret' => $secret,
    ...
    $url = MoAuthConstants::$AUTH_REGISTER_GOOGLE_AUTH_API;
  ...
  public function registerQRCode(MiniorangeUser $user) {
    ...
    $url = MoAuthConstants::$AUTH_REGISTER_MOBILE_API;
